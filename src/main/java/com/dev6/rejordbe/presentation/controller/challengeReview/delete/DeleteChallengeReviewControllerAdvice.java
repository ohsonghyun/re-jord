...
/**
 * DeleteChallengeReviewControllerAdvice
 */
@RestControllerAdvice(basePackageClasses = DeleteChallengeReviewController.class)
@Slf4j
public class DeleteChallengeReviewControllerAdvice {
